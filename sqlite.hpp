  ...
  private:
    ...
    class cursor
    {
      public:
        ...
        std::optional<row> next()
        {
            ...
            std::vector<column_types> values(ncols);
    ...
    class row
    {
      private:
        ...
        row(size_t ncols, const std::vector<const char*>& names,
            const std::vector<column_types>& values)
        {
    ...
    class field
    {
      ...
      private:
        ...
        field(const char* name, const column_types& value)
            : name_(name)
        {
            switch (value.index()) {
            case 0:  // int64_t
